...
public class AntidisturbiosItem extends Item {
	public AntidisturbiosItem() {
		super(new Item.Properties().tab(KlvModTabs.TAB_KL).durability(3200));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (AntidisturbiosCanUseRangedItemProcedure.execute()) {
				AntidisturbiosEntity entityarrow = AntidisturbiosEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
