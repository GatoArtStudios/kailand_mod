...
public class GuadanaItem extends SwordItem {
	public GuadanaItem() {
		...
		}, 3, -2.9f, new Item.Properties().tab(KlvModTabs.TAB_KL));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GuadanaProcedureProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77Esta cuchilla hace al jugador invisible durante 45 segundos al activarse"));
	}
}
